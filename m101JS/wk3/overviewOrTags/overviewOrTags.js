...
function queryDocument(options) {
    ...
    if ("overview" in options) {
        ...
        */
        // overview === options.overview OR tag_list === options.overview
        // {$or: [{"overview": "something"}, {"tag_list": "something"} ]}

        // good: {"overview": {"$regex": "wiki", $options: "i"}}
        // good: {"tag_list": {"$regex": "wiki", $options: "i"}}
